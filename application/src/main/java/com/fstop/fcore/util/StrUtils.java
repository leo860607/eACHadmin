...
public class StrUtils {
	...
	/**
	 * �N�r���ରURL�W�� �̷�JavaScript��escape��k���W�� 1. ���s�X���Ÿ��]�A: @*+/ 2.
	 * scape ���s�X + (�[��), �N�Ϫ������Ƥ����ťժ��B�z(�� + �s���r��)�y�����D�C �B
	 * escape �b�B�z�D ASCII �y�t���r���|�����D�C
	 * 
	 * @param str �ݭn��X���r��
	 * @return �^����X�᪺�r��
	 */
	...
	/**
	 * �NURL�W���ন�r�� �̷�JavaScript��escape��k���W�� 1. ���s�X���Ÿ��]�A: @*+/ 2.
	 * scape ���s�X + (�[��), �N�Ϫ������Ƥ����ťժ��B�z(�� + �s���r��)�y�����D�C �B
	 * escape �b�B�z�D ASCII �y�t���r���|�����D�C
	 * 
	 * @param str �ݭn��X���r��
	...
	/*
	 * ��֤ߥD���^�Ǫ��q��i����X 1. ���Y���26 2.
	 * ���Y��o�q���`���-���Y���=>�ݭn�P�_�ѪR���s�X
	 */
	...
	/*
	 * �ǵ��֤ߥD�����q��i����X ����r��s�X�e�ݥ[(byte)04 ����ݥ[(byte)07
	 */
	 ...
	 * @return
	 */
	public static String formatString(char format, String str, int length) {
	 ...
	 * @return
	 */
	public static String formatString2(char format, String str, int length) {
		StringBuffer formatBuf = new StringBuffer();
		int slen = str.getBytes().length;
		if (slen == length) {
			return str;
	...
	/**
	 * �̿�J���榡�Ө�X��Ƥ����ƭȡA�H�զ��Ʀr�r���X ����J�榡�h�̭��ƿ�X ����ɶ��榡�� java
	 * �즳�榡�w�q���ǡA�Ҧp�G yyyy/MM/dd hh:mm:ss
	 * 
	 * @param data    ���榡���r��
	 * @param pattern �r��榡
	 * @return �L�榡���Ʀr�r��
	...
	/**
	 * �N��J���ƭȦr��榡�ơA�i��w�榡 �Y����J�榡�A�w�]���G 12345 -> 12,345.00
	 * 
	 * @param data    �ƭȦr��
