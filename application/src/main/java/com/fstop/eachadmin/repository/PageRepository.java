...
@Getter
@Setter
public class PageRepository implements Serializable{
...
//	}
	...
	public PageRepository(int i, int j, int dEFAULT_PAGE_SIZE2, ArrayList arrayList) {
...
//		this.data = data;
//	}
	public PageRepository(long start, long totalSize, int pageSize, Object data) {
		this.pageSize = pageSize;
		this.start = start;
		this.totalCount = totalSize;
		this.data = data;
