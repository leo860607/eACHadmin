...
@Repository
public class EachFincListDao extends JpaRepository<EACH_FUNC_LIST, java.io.Serializable> {
     ...
     * @return
     */
    public List<Map> funcIsUsed(String func_id , java.util.List<String> inVals){
        List<Map> list = null;
...
//		sql.append(" ORDER BY  CAST (M.FUNC_SEQ AS INT),CAST ( S.FUNC_SEQ AS INT )  WITH UR  ") ;
        ...
        org.hibernate.SQLQuery query = getCurrentSession().createSQLQuery(sql.toString());
        query.addScalar("htmlId" , org.hibernate.Hibernate.STRING);
        query.addScalar("UP_FUNC_NAME" , org.hibernate.Hibernate.STRING);
        query.addScalar("FUNC_ID" , org.hibernate.Hibernate.STRING);
        query.addScalar("FUNC_NAME" , org.hibernate.Hibernate.STRING);
        query.addScalar("UP_FUNC_ID" , org.hibernate.Hibernate.STRING);
        query.addScalar("IS_USED" , org.hibernate.Hibernate.STRING);
        query.setResultTransformer(org.hibernate.transform.Transformers.aliasToBean(EACH_FUNC_LIST.class));
//		query.addEntity(EACH_FUNC_LIST.class);
...
//		query.addEntity(EACH_FUNC_LIST.class);
        query.addScalar("FUNC_ID" , org.hibernate.Hibernate.STRING);
        query.addScalar("UP_FUNC_ID" , org.hibernate.Hibernate.STRING);
        query.addScalar("AUTH_TYPE" , org.hibernate.Hibernate.STRING);
        query.addScalar("IS_USED" , org.hibernate.Hibernate.STRING);
        query.setResultTransformer(org.hibernate.transform.Transformers.aliasToBean(EACH_FUNC_LIST.class));
        List<EACH_FUNC_LIST> list = query.list();
        return list;
