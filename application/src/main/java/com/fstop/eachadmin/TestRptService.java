...
//      String templatePath = "classpath:templates/contract.jrxml";
		...
		public List getOpbkIdList(){
			List list = bank_group_Dao.getBgbkIdList_2();
		...
		public List getBsTypeIdList() {
	        throw new Error("Unresolved compilation problems: \n\tLabelValueBean cannot be resolved to a type\n\tLabelValueBean cannot be resolved to a type\n\tLabelValueBean cannot be resolved to a type\n\tLabelValueBean cannot be resolved to a type\n\tLabelValueBean cannot be resolved to a type\n\tLabelValueBean cannot be resolved to a type\n");
	    }	
//收尋
...
//1400
		public String servic1400(Map<String, String> param){
			String json = "{}";
...
=======
>>>>>>> ef6b7bcc00c77d4548688fadd262be7210dbc2be
}
