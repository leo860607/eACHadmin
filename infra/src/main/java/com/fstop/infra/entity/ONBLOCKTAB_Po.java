...
@Getter
@Setter
@Entity(name = "tw.org.twntch.po.ONBLOCKTAB_Po")
@Table(name = "ONBLOCKTAB_Po")
public class ONBLOCKTAB_Po implements Serializable {
    /**
     *
     */
    ...
    //查詢統計的交易資料查詢的onblocktab_Po_trad_edit_q.jsp裡的RC1~RC6的說明要加上TXN_ERROR_CODE的ERROR_DESC而設
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ONBLOCKTAB_Po other = (ONBLOCKTAB_Po) obj;
        if (ACCTBAL == null) {
